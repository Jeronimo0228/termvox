...
class Termvox < Formula
  ...
  url "https://github.com/Jeronimo0228/termvox/releases/download/v0.1.0-alpha.15/termvox-v0.1.0-alpha.15-x86_64-apple-darwin.tar.gz"
...
```text
termvox_0.1.0-alpha.15_amd64/
  usr/local/bin/termvox
  usr/share/doc/termvox/copyright
```

3. `dpkg-deb --build termvox_0.1.0-alpha.15_amd64`
